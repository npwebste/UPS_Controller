...
def Protection_Controller(arg):
    ...
    if (Solar_Voltage >= Parameters.Solar_VDC_Max or Solar_Voltage <= Parameters.Solar_VDC_Min):
        ...
        PWM.PWM_Write(Parameters.PWMPin,Parameters.PID_OLD_INIT*Parameters.Range) # Reset PWM duty cycle to initial value
    ...
    # Reschedule the protection controller and run
