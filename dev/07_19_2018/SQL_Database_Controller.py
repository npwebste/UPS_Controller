...
def SQL_Database_Controller(arg):
    ...
    try:
        ...
        c = conn.cursor()
        c.execute("INSERT INTO UPS_DB(Date,Solar_Voltage, DC_Link_Voltage, VFD_Freq, VFD_Volt, VFD_Amps, VFD_Power, VFD_BusVolt, VFD_Temp) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)",(Currenttime, Solar_Voltage,DC_Link_Voltage, Duty_Cycle,VFD_Freq,VFD_Volt,VFD_Amps,VFD_Power, Grid_Power, Solar_Power, VFD_BusVolt,VFD_Temp))
        conn.commit()
