...
def Run_Initialization():
    ...
    try:
        ...
        c = conn.cursor()
        c.execute('''CREATE TABLE UPS_DB(Date date,Solar_Voltage real, DC_Link_Voltage real, Duty_Cycle real, VFD_Freq real, VFD_Volt real, VFD_Amps real, VFD_Power real, Grid_Power real, Solar_Power real, VFD_BusVolt real, VFD_Temp real)''')
        conn.commit()
