      ...
      )
{
   ...
   if( scipParaDiffSubproblem )
   {
      ...
      if( scipParaDiffSubproblem->getNLinearConss() > 0 || scipParaDiffSubproblem->getNBoundDisjunctions() )
      {
         assert(addedConss == 0);
         addedConss = new SCIP_CONS*[scipParaDiffSubproblem->getNLinearConss() + scipParaDiffSubproblem->getNBoundDisjunctions()];
      }
      ...
      for(; c < scipParaDiffSubproblem->getNLinearConss() ; c++ )
      {
         ...
         if( mapToProbIndecies )
         {
            ...
            {
               vars[v] = orgVars[mapToProbIndecies[mapToSolverLocalIndecies[scipParaDiffSubproblem->getIdxLinearCoefsVars(c,v)]]];
      ...
      int i = 0;
      for(; c < (scipParaDiffSubproblem->getNLinearConss() + scipParaDiffSubproblem->getNBoundDisjunctions()) ; c++ )
      {
         SCIP_VAR** vars;
