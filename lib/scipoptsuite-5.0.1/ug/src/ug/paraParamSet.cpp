...
ParaParamSet::ParaParamSet()
{
  ...
  /** bool params */
   ...
   paraParams[NStopSolvingMode] = new ParaParamInt(
         "NStopSolvingMode",
         "# Number of nodes solved less than this value can be a candidate of stop solving mode. The value less than 0 means no stop solving. [Default: 3.0][-1.0, INT_MAX]",
         3.0,
         -1,
         INT_MAX);
