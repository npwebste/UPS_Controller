...
class MisdpUserPlugins : public ScipUserPlugins {
   void operator()(SCIP *scip)
   {
      ...
      SCIP_CALL_ABORT( SCIPsetIntParam(scip, "lp/rowagelimit", 10) );
      SCIP_CALL_ABORT( SCIPsetIntParam(scip, "separating/cutagelimit", 10) );
      SCIP_CALL_ABORT( SCIPsetIntParam(scip, "separating/maxrounds", 20) );
