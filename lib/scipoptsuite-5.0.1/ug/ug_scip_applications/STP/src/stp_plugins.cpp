...
class StpUserPlugins : public ScipUserPlugins {
   void operator()(SCIP *scip)
   {
      ...
      SCIP_CALL_ABORT( SCIPsetSubscipsOff(scip, FALSE) );
      ...
      SCIP_CALL_ABORT( SCIPsetIntParam(scip, "separating/maxcutsroot", 10000) );
      SCIP_CALL_ABORT( SCIPsetIntParam(scip, "separating/maxincrounds", -1) );
      SCIP_CALL_ABORT( SCIPsetRealParam(scip, "separating/minefficacyroot", 0.01) );
      SCIP_CALL_ABORT( SCIPsetRealParam(scip, "separating/minorthoroot", 0.3) );
      SCIP_CALL_ABORT( SCIPsetRealParam(scip, "separating/minortho", 0.4) );
      SCIP_CALL_ABORT( SCIPsetRealParam(scip, "separating/objparalfac", 0.1) );
